...
pub fn rx_gate(control_qubit_index: u32, angle: f64, state: &mut Vec<Complex<f64>>) {
	wrap(
		state,
...
pub fn ry_gate(control_qubit_index: u32, angle: f64, state: &mut Vec<Complex<f64>>) {
	wrap(
		state,
...
pub fn rz_gate(control_qubit_index: u32, angle: f64, state: &mut Vec<Complex<f64>>) {
	wrap(
		state,
